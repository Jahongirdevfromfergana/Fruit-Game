...
import com.example.catchapp.databinding.ActivityMainBinding
import java.util.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        object : CountDownTimer(10000, 1000) {
            ...
            override fun onFinish() { // oyun bitiminde neler olacak
                binding.tvTime.text = "Catch the Fruits !!!" // zaman dolunca mesaj yaz.
                ...
                dialog.setMessage("Sizning natijangiz: $score\nQaytadan o'ynampqchimisiz?")
